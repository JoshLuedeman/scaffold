...
public class DdlTranslatorTests
{
    ...
    public void GenerateCreateTable_SimpleTable_ContainsColumnsAndPK()
    {
        ...
        Assert.Contains("\"Id\" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL", result);
    ...
    public void GenerateCreateTable_IdentityColumn_UsesGeneratedByDefault(string dataType, string expectedFragment)
    {
    ...
    public void GenerateCreateTable_IdentityColumn_DoesNotIncludeDefault()
    {
        ...
        // Identity columns should not get a DEFAULT <value> clause
        Assert.DoesNotContain("DEFAULT ((1))", result);
        Assert.DoesNotContain("DEFAULT 1", result);
        // But should still have GENERATED BY DEFAULT AS IDENTITY
    ...
    [Theory]
    [InlineData("((1))", "DEFAULT true")]
    [InlineData("((0))", "DEFAULT false")]
    public void GenerateCreateTable_BitDefaultExpression_ConvertsToBooleanLiteral(string sqlDefault, string expectedFragment)
    {
        var table = new TableDefinition
        {
            Schema = "dbo",
