...
## Project Knowledge
- **Tech Stack:** .NET 8, ASP.NET Core, EF Core, React 19, TypeScript 5.9, Vite, Fluent UI v9
...
- **Code Quality Tools:** XPlat Code Coverage, ESLint, TypeScript strict mode
- **Testing Standards:** See `.github/instructions/testing.instructions.md` — all existing tests must pass after every change. If test coverage is insufficient to verify behavior preservation, add tests first as a separate preliminary step before refactoring.
